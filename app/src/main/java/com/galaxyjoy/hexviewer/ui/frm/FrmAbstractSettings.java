...
public abstract class FrmAbstractSettings extends PreferenceFragmentCompat {
    ...
    protected void displayDialog(CharSequence title,
                                 int defaultValue,
                                 int minValue,
                                 int maxValue,
                                 InputValidated<Integer> iv) {
    ...
    private boolean validateInputValue(EditText et,
                                       InputValidated<Float> iv,
                                       float nb,
                                       float minValue,
                                       float maxValue,
     ...
     */
    protected boolean validInput(EditText et,
                                 float defaultValue,
                                 float minValue,
                                 float maxValue,
                                 InputValidated<Float> iv,
