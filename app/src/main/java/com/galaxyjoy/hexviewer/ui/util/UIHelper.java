...
//        final ViewGroup nullParent = null;
     ...
     * @return The width.
     */
    public static int getMaxByLine(final Context context,
                                   final UserConfig landscape,
                                   final UserConfig portrait) {
        int width = getTextWidth(context,
                landscape,
                portrait);
...
//            paint.setTypeface(monospace);
     ...
     */
    private static float getSize(final Context context,
                                 int unit,
                                 float value) {
        return TypedValue.applyDimension(unit,
                value,
     ...
     */
    public static long getCurrentLine(int position,
                                      long startOffset,
                                      int maxByRow) {
     ...
     */
    public static void openFilePickerInFileSelectionMode(final Context c,
                                                         final ActivityResultLauncher<Intent> activityResultLauncher,
                                                         final View snackBarLayout) {
        try {
