...
public class LauncherOpen {
    ...
    public void startActivity() {
        UIHelper.openFilePickerInFileSelectionMode(mActivity,
        ...
        activityResultLauncherOpen = mActivity.registerForActivityResult(
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (data != null) {
                            if (FileHelper.takeUriPermissions(mActivity,
                                    data.getData(),
                                    false)) {
                                processFileOpen(new FileData(mActivity,
                                        data.getData(),
                                        false,
                                        0L,
                                        0L));
                                ...
                                UIHelper.showErrorDialog(mActivity,
                                        ...
                                        String.format(mActivity.getString(R.string.error_file_permission), FileHelper.getFileName(mApp, data.getData())));
                        } else {
